...
education level, 
family income \footnote{We have to consider the special cases such as underaged individuals taking income from their family. This group of individuals may have above average life satisfactions with no personal income. “Income_respondent” is hence removed from our model.}, 
marital status \footnote{“marital_status” is chosen over “living_arrangement” since the former is more descriptive and specific. For instance, by living “along” under “living_arrangement”, an individual can be separated, divorced or widowed.
}
or 
self rated health \footnote{We assume that an individual’s physical health will have greater influence on his or her life satisfaction. As an individual’s physical health can affect his or her mental health and vice versa, “self_rated_mental_health” was also removed to avoid multicollinearity.}
...
is assumed to be more likely to have above average life satisfaction than female, due to gender inequalities at workplace, home, etc. Individuals living in rural areas or Prince Edward Island are more likely to have above average life satisfaction than those living in urban 
areas \footnote{We assume that an individual’s appetite for a living environment impacts more on his or her life satisfaction than the general geographic region. “pop_center” is hence selected over “province” or “region”.}
, due to a more relaxed lifestyle.\par
...
ggplot(data, aes(self_rated_health,feelings_life))+
  geom_boxplot()
```
As indicated by the sample boxplot (Figure \@ref(fig:dis)) that measures the relationship between feelings_life and self_rated_health, there are apparent differences between each health category. A clear trend of increasing life satisfaction exists as the respondents’ health condition improves. \par
