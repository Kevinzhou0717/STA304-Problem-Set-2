...
ggplot(data, aes(self_rated_health,feelings_life))+
  geom_boxplot()
```
As indicated by the sample boxplot (Figure \@ref(fig:bp)) that measures the relationship between feelings_life and self_rated_health, there are apparent differences between each health category. A clear trend of increasing life satisfaction exists as the respondents’ health condition improves. \par
